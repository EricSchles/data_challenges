...
clf2 = KNeighborsClassifier(n_neighbors=7) #strong
clf3 = SVC(random_state=0, kernel='rbf', probability=True) #strong
clf4 = SVC(gamma=2, C=1, probability=True) #strong
clf5 = LogisticRegression(random_state=0) #weak
clf6 = RandomForestClassifier(random_state=0) #strong
clf7 = GaussianNB() #weak
clf8 = MLPClassifier(alpha=1) #weak
clf9 = AdaBoostClassifier() #weak


estimators = [
    ('dt', clf1), ('knn', clf2), ('svm', clf3),
    ('svm_gamma', clf4),('lr', clf5),
    ('rf', clf6), ('gnb', clf7),
    ('mlp', clf8), ('ada', clf9)
]
...
for label, clf in estimators:
    ...
    if label == 'knn':
        ...
        clf = GridSearchCV(estimator=clf2, param_grid=params, cv=5)
